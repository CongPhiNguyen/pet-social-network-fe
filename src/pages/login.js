    ...
    return (
        <>
            <Row style={{ width: "100vw" }}>
                ...
                <Col className='login-form-warpper' style={{ height: "100vh" }} xs={24} md={8}>
                    <Form
                        form={form}
                        layout="vertical"
                        name="basic"
                    ...
                    >
                        ...
                        <p style={{ textAlign: "center" }} className="my-2">
                            You don't have an account? <Link to="/register" style={{ color: "crimson", fontWeight: "700" }}>Register Now</Link>
                        </p>
                    </Form>
                </Col>
            </Row>
