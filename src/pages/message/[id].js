...
const Conversation = () => {
  ...
  return (
    <Row gutter={[24, 0]} style={{ paddingTop: 128, overflow: "hidden", marginRight: 0 }}  >
      ...
      <Col style={{ height: 'calc(100vh - 192px)', position: "relative" }} xs={2} md={0}>
        <div onClick={() => { navigate("/message") }} className="btn-back">
          <MdArrowBack style={{ fontSize: "1.4rem", transform: "translate(9px, 8px)" }}></MdArrowBack>
        </div>
      </Col>
